...
class _OtpScreenState extends State<OtpScreen> {
  ...
  void didChangeDependencies() {
    ...
    if (_savedArgs == null) {
      _savedArgs =
          ...
          {};
      print(
        '[OTP] Args received: phone=${_savedArgs!['phone']}, purpose=${_savedArgs!['purpose']}, hasOtp=${_savedArgs!.containsKey('otp')}',
      );
    }
  ...
  Future<void> _verify(BuildContext context) async {
    ...
    final otpToVerify = _pinController.text.isNotEmpty
        ? _pinController.text
        : _otp;
    ...
    try {
      if (purpose == 'customer_login') {
        await context.read<AuthProvider>().verifyCustomerLogin(
          phone,
          otpToVerify,
        );
      ...
      if (!mounted) return;
      final destination =
          context.read<AuthProvider>().session?.role == 'customer'
          ? '/customer-home'
          : '/home';
