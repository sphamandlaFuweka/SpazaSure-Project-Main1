...
builder.Services.AddSwaggerGen(c =>
{
    ...
    {
        Title = "SpazaSure Analytics Service",
        Version = "v1",
        Description = "Sales and business analytics for suppliers and shops"
    });
...
app.UseSwaggerUI(c =>
{
    c.SwaggerEndpoint("/swagger/v1/swagger.json", "SpazaSure Analytics Service v1");
